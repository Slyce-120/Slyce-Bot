...
handler.before = async (m, { conn }) => {
    ...
    if (msgText === 'pesca' || msgText === '📥 pesca') {
        ...
        if (carta.includes('Jolly')) {
            ...
            s.currentColor = colori[Math.floor(Math.random() * colori.length)]
            report = `✅ Hai giocato ${carta}. Colore scelto: *${s.currentColor}*`
        } else {
